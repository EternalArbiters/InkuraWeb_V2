...
export default function CommentSection({
  ...
  const fetchComments = async () => {
    ...
    setInfo(null);
    try {
      const qs = new URLSearchParams({ targetType, targetId, take: "100" });
  ...
  return (
    <section className="mt-10">
      <div className="flex items-end justify-between gap-3">
        ...
        <button onClick={fetchComments} className="text-sm font-semibold text-purple-600 dark:text-purple-400 hover:underline">
          Refresh
        </button>
      </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <label className="inline-flex items-center gap-2 text-xs font-semibold border border-gray-300 dark:border-gray-700 px-3 py-1.5 rounded-full hover:bg-gray-50 dark:hover:bg-gray-900 cursor-pointer">
                <input
                  type="file"
                  multiple
                  accept="image/*"
              ...
              return (
                <div key={c.id} className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 px-4 py-3">
                  ...
                  {hidden ? (
                    ...
                    <p className="mt-2 text-sm whitespace-pre-line text-gray-700 dark:text-gray-200">{c.body}</p>
                  )}
