    ...
    <ListSurface>
      <div className="max-w-4xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">{tReadingHistory}</h1>
          </div>
          <Link
            href="/settings/account"
            className="rounded-full px-4 py-2 text-sm font-semibold border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-center"
          >
            {tAccountSettings}
          </Link>
        </div>
        ...
        {progress.length === 0 ? (
          <p className="mt-6 text-sm text-gray-600 dark:text-gray-300">{tNoHistory}</p>
        ) : (
