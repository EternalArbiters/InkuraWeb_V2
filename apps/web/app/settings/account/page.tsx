      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">Preferences, creator role, and content filters.</p>
          </div>
          <Link
            href="/home"
        ...
        <PreferencesForm
          ...
          initial={{
            ...
            matureOptIn: prefsRes.data.prefs.matureOptIn,
            creatorRole: prefsRes.data.prefs.creatorRole,
