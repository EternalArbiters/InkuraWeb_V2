  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {works.map((w: any) => {
        ...
        return (
          <div key={w.id} className="relative group overflow-hidden rounded-[28px] border border-gray-200 bg-white/70 transition hover:shadow-lg dark:border-gray-800 dark:bg-gray-900/50">
            {isOwner ? (
              <button
                type="button"
                disabled={pending}
