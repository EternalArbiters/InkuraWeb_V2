...
export const UPLOAD_PROFILES: Record<UploadOptimizationScope, UploadOptimizationProfile> = {
  ...
  pages: {
    ...
    skipReencodeBelowBytes: 900 * KB,
    notes: [
      "Prioritize readability over raw byte savings for comic pages.",
      "Use adaptive downscaling instead of a single hard long-edge rule.",
    ],
  },
  files: {
    scope: "files",
