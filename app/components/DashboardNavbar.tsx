...
export default function DashboardNavbar() {
  ...
  const userRole = String((session as any)?.user?.role || "USER").toUpperCase();
              ...
              <div className="relative">
                ...
                {dropdown === "settings" && (
                  <div className="absolute mt-2 right-0 z-50 bg-white dark:bg-gray-800 border rounded shadow-lg w-48">
                    ...
                    <Link href="/report" className="block px-4 py-2 hover:bg-gradient-to-r from-pink-500 to-purple-500 hover:text-white">Admin Report</Link>
                    {userRole === "ADMIN" && (
                      <Link href="/admin/report" className="block px-4 py-2 hover:bg-gradient-to-r from-pink-500 to-purple-500 hover:text-white">Reports (Admin)</Link>
                    )}
